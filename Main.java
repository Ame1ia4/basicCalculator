...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter C for normal calculator, M for Matrices calculator, or m for Music Calculator: ");//prints out options for calculator the user can choose, prompts the user to type calculator choice
